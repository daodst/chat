...
func SendServerNotice(
	...
	if device.AccountType != userapi.AccountTypeAdmin && device.DisplayName != cfgNotices.LocalPart { // ，admin
	...
	// get rooms of the sender  _server
	...
	if len(commonRooms) == 0 {
		...
		if !membershipRes.IsInRoom {
			...
			if err != nil {
				...
				userutil.PerformJoinRoomForSpecUser(ctx, roomID, r.UserID, userAPI, rsAPI)
			}
		}
	}
...
func getSenderDevice(
	...
	err := userAPI.PerformAccountCreation(ctx, &userapi.PerformAccountCreationRequest{
		AccountType: userapi.AccountTypeAdmin, // admin
