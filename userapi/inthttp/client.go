...
import (
	"context"
	"errors"
	types2 "github.com/matrix-org/dendrite/internal/types"
...
func (h *httpUserInternalAPI) InsertAddressBook(ctx context.Context, localpart string, friendLocalpart []string) (err error) {
	//TODO implement me
	panic("implement me")
}

func (h *httpUserInternalAPI) SetChatFee(ctx context.Context, localpart string, chatFee string) (err error) {
	//TODO implement me
	panic("implement me")
}

func (h *httpUserInternalAPI) SetMortgageFee(ctx context.Context, localpart string, mortgageFee string) (err error) {
	//TODO implement me
	panic("implement me")
}

func (h *httpUserInternalAPI) SelectChainData(ctx context.Context, localpart string) (*types2.UserChainInfo, error) {
	//TODO implement me
	panic("implement me")
}

func (h *httpUserInternalAPI) InsertRelationInvite(ctx context.Context, inviter string, invitee string, presentFee string) (err error) {
	//TODO implement me
	panic("implement me")
}

func (h *httpUserInternalAPI) InsertChainData(ctx context.Context, localpart string, servername string, chatFee string, mortgageFee string) (err error) {
	//TODO implement me
	panic("implement me")
}

func (h *httpUserInternalAPI) AddTelNumbers(ctx context.Context, localpart string, telNums []int64) (err error) {
	//TODO implement me
	panic("implement me")
}

func (h *httpUserInternalAPI) JudgeShouldAutoJoin(ctx context.Context, inviter, invitee string) (bool, error) {
	if os.Getenv("CHAT_SERVER_MODE") != "chain" {
		return true, nil
	}
	// 1，limit_mode fee() | any（） | list（））
	inviterLocal, _, err := gomatrixserverlib.SplitID('@', inviter)
	if err != nil {
		return false, err
	}
	inviteeLocal, _, err := gomatrixserverlib.SplitID('@', invitee)
	if err != nil {
		return false, err
	}
	return new_feature.JudgeShouldAutoJoin(inviterLocal, inviteeLocal)
}
